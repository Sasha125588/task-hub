...
function TabsList({
	...
	return (
		<MotionHighlight
			controlledItems
			className={cn(
				"bg-primary/10 dark:bg-primary/15 rounded-lg shadow-xs",
				activeClassName
			)}
			value={activeValue}
			transition={transition}
		>
			<TabsPrimitive.List
				...
				data-slot="tabs-list"
				className={cn(
					"bg-card inline-flex h-10 w-fit items-center justify-center rounded-lg p-[4px] text-zinc-500 dark:text-zinc-400",
					className
				)}
				{...props}
			>

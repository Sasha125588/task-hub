	...
	return (
		...
		>
			...
			<div
				...
				className={cn(
					'w-(--sidebar-width) duration-400 relative bg-transparent transition-[width] ease-[cubic-bezier(0.7,-0.15,0.25,1.15)]',
			...
			<div
				...
				className={cn(
					'w-(--sidebar-width) duration-400 fixed inset-y-0 z-10 hidden h-svh transition-[left,right,width] ease-[cubic-bezier(0.75,0,0.25,1)] md:flex',
					side === 'left'
...
function SidebarGroupLabel({
	...
	return (
		<Comp
			...
			className={cn(
				'text-sidebar-foreground/70 ring-sidebar-ring outline-hidden flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium transition-[margin,opacity] duration-300 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
function SidebarMenuAction({
	...
	return (
		<Comp
			...
			className={cn(
				// Increases the hit area of the button on mobile.
				'text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground peer-hover/menu-button:text-sidebar-accent-foreground outline-hidden absolute right-1 top-1.5 z-[1] flex aspect-square w-5 items-center justify-center rounded-md p-0 transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
				'after:absolute after:-inset-2 md:after:hidden',
